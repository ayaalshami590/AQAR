...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 15, 2025 at 07:26 AM
...
ALTER TABLE `properties`
  ...
  ADD CONSTRAINT `properties_ibfk_2` FOREIGN KEY (`location_id`) REFERENCES `locations` (`id`) ON DELETE CASCADE;
